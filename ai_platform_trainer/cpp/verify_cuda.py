...
if torch.cuda.is_available():
    ...
    try:
        ...
        print(
            "GPU detected but tensor allocation failed. This may be due to compatibility issues."
        )
        print(
        ...
        print(
            "The physics module will use the CUDA compiler directly"
        ...
        try:
            ...
            if result.returncode == 0:
                print(
                    "CUDA compiler (nvcc) is available and will be used for physics compilation"
                )
                print(result.stdout.strip())
                print("\nCUDA direct compilation test: SUCCESS")
                print(
                    "Our build system will use CUDA directly,"
