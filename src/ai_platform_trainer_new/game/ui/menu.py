...
This module provides a simplified menu system for game mode selection.
"""
import pygame
...
class Menu:
    ...
    def __init__(self, screen_width: int, screen_height: int):
        ...
        self.descriptions = {
            ...
            "training": "Collect gameplay data and train AI models",
    ...
    def render(self, screen: pygame.Surface):
        ...
        # Subtitle
        subtitle_text = self.font_small.render("Interactive AI Training Platform", True, self.description_color)
